 ...
 */
declare function makeGradFn(fn: (...params: any[]) => number): (...args: any[]) => Result;
...
*/
declare function fwdMakeGradFn_unstable(fn: (...args: any[]) => number): (...args: any[]) => never | {
    value: number;
    gradients: any[];
};

export { makeGradFn as default, fwdMakeGradFn_unstable };
